...
<div
  class="relative overflow-hidden rounded-lg border border-neutral-200/70 bg-neutral-50 px-4 py-5 transition-colors duration-200 ease-in-out hover:border-teal-400 hover:bg-teal-50 dark:border-neutral-800/70 dark:bg-neutral-900/70 dark:hover:border-teal-500 dark:hover:bg-teal-900/70 sm:px-6 sm:py-6 {classProp}"
>
  <dt>
    <p
  ...
  <dd class="mt-1 flex items-baseline justify-between md:block lg:flex">
    <div
      class="flex items-baseline text-2xl font-semibold text-neutral-600 dark:text-neutral-300"
    >
