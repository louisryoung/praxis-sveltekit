    ...
    <div class="flex w-full items-center justify-between">
      <div class="w-full flex-1">
        <dl class="grid w-full grid-cols-2 gap-y-1.5">
          <dt
            class="truncate text-sm font-medium capitalize text-neutral-600 dark:text-neutral-400"
          >
            Status
          </dt>
          <dd>
          ...
          <dt
            class="group relative inline-flex items-center justify-start gap-2 text-sm font-medium capitalize text-neutral-600 dark:text-neutral-400"
          >
          ...
          <dt
            class="relative inline-flex items-center justify-start gap-2 text-sm font-medium capitalize text-neutral-600 dark:text-neutral-400"
          >
