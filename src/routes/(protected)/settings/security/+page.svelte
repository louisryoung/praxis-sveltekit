  ...
  >
    <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
      ...
      <div class="col-start-1 sm:col-span-3">
        <label
          for="first-name"
          class="block text-sm font-medium capitalize text-neutral-900 dark:text-neutral-100"
          >Old password</label
        >
        <input
          type="text"
          ...
          class="mt-1 block w-full rounded-md border-neutral-300 text-neutral-900 shadow-sm transition-colors duration-200 ease-in-out focus:border-teal-500 focus:ring-teal-500 dark:border-neutral-700 dark:bg-black dark:text-neutral-100 sm:text-sm"
        />
      </div>
